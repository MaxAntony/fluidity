...
const RedditUser = ({ user }: { user: string }) => <Link href={`https://www.reddit.com/user/${user}`}>u/{user}</Link>;
...
export const changelog: ChangelogVersion[] = [
  {
    ...
    changes: [
      ...
      <>
        Added some new themes. Thanks to <RedditUser user='justanotherweirdteen' /> for contributing!
      </>,
    ],
  },
  {
    ...
    changes: [
      <>
        Added new theme &quot;Tartarus&quot;. Thanks to <RedditUser user='AllJavi' /> for contributing! <br />(
